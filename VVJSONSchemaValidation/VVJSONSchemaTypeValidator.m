...
NSString *
NSStringFromVVJSONSchemaInstanceTypes(VVJSONSchemaInstanceTypes types);
...
- (NSString *)description {
  return [[super description]
      stringByAppendingFormat:@"{ allowed types: %@ }",
                              NSStringFromVVJSONSchemaInstanceTypes(
                                  self.types)];
}
...
- (BOOL)validateInstance:(id)instance
  ...
  if ((types & VVJSONSchemaInstanceTypesObject) != 0 &&
      [instance isKindOfClass:[NSDictionary class]]) {
    return YES;
  }
  if ((types & VVJSONSchemaInstanceTypesArray) != 0 &&
      [instance isKindOfClass:[NSArray class]]) {
    return YES;
  }
  if ((types & VVJSONSchemaInstanceTypesString) != 0 &&
      [instance isKindOfClass:[NSString class]]) {
    return YES;
  }
  if ((types & VVJSONSchemaInstanceTypesInteger) != 0 &&
      [instance isKindOfClass:[NSNumber class]] && [instance vv_isInteger]) {
    return YES;
  }
  if ((types & VVJSONSchemaInstanceTypesNumber) != 0 &&
      [instance isKindOfClass:[NSNumber class]] &&
      [instance vv_isBoolean] == NO) {
    return YES;
  }
  if ((types & VVJSONSchemaInstanceTypesBoolean) != 0 &&
      [instance isKindOfClass:[NSNumber class]] && [instance vv_isBoolean]) {
    return YES;
  }
  if ((types & VVJSONSchemaInstanceTypesNull) != 0 &&
  ...
  if (error != NULL) {
    ...
    *error =
        [NSError vv_JSONSchemaValidationErrorWithFailingValidator:self
...
VVJSONSchemaInstanceTypes VVJSONSchemaInstanceTypeFromString(NSString *string) {
  ...
  dispatch_once(&onceToken, ^{
    mapping = @{
      @"object" : @(VVJSONSchemaInstanceTypesObject),
      @"array" : @(VVJSONSchemaInstanceTypesArray),
      @"string" : @(VVJSONSchemaInstanceTypesString),
      @"integer" : @(VVJSONSchemaInstanceTypesInteger),
      @"number" : @(VVJSONSchemaInstanceTypesNumber),
      @"boolean" : @(VVJSONSchemaInstanceTypesBoolean),
      @"null" : @(VVJSONSchemaInstanceTypesNull)
    };
  });
